...
// ============================================================================
// MOB-INCOME-1: Operational Income DTOs
// ============================================================================
...
class IncomeDto {
  ...
  factory IncomeDto.fromJson(Map<String, dynamic> j) => IncomeDto(
        id: j['id'] as String,
        businessId: j['business_id'] as String,
        branchId: j['branch_id'] as String?,
        date: j['date'] as String,
...
class PullIncomeResponse {
  final List<IncomeDto> items;
  final int total;

  const PullIncomeResponse(this.items, this.total);

  factory PullIncomeResponse.fromJson(Map<String, dynamic> j) {
    final rawList = j['rows'] as List? ?? j['items'] as List? ?? [];
    return PullIncomeResponse(
      rawList
          .map((e) => IncomeDto.fromJson(e as Map<String, dynamic>))
          .toList(),
      (j['total'] as num?)?.toInt() ?? rawList.length,
    );
  }
