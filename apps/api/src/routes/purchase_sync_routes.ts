...
import { createPurchaseSyncService } from '../services/purchase_sync_service'
import { asyncHandler } from '../utils/async_handler'

export function createPurchaseSyncRouter(pool: Pool): Router {
  const router = Router()
  const service = createPurchaseSyncService(pool)
